...
abstract final class ColossusDefinitions {
  ...
  static const List<int> specialSkillUnlockLevels = <int>[
    50,
    70,
    90,
    110,
  ...
  static const Map<ColossusType, List<ColossusStatDefinition>>
      statsByColossus = <ColossusType, List<ColossusStatDefinition>>{
